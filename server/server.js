...
const { initGame, checkIsWinner, moveRollDice,endTurn,movePlaceSoldier,evaluateAttack} = require('./game');
...
io.on('connection', client => {
  ...
  client.on('attack',(data) =>{
    handleAttack(data.attacker,data.defender); //kahe riigi nimed, omanikud saab selle j2rgi
  })
